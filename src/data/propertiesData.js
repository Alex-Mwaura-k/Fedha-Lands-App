export const properties = [
  {
    ...
    // UPDATED: Unique slug to prevent conflict with Phase 4 and 6
    ...
    // SEO Recommendation: Meta Description for search results
    metaDescription:
      "Buy prime 50x100 plots in Kithyoko, Machakos Phase 5. Red soil, ready for settlement with water and electricity on site.",
    features: [
  ...
  },
  {
    ...
    metaDescription:
      "Massive 1-acre investment plots in Malindi at Kijani Garden. Ideal for holiday homes and farming with ocean breeze and titles.",
    features: [
      "Freehold Title Deed.",
      "Near Tarmac.",
      "Ocean Breeze.",
  ...
  },
  {
    ...
    metaDescription:
      "High-value commercial plots for sale in Makutano, Mwea. Ideal for rental flats and business centers near the dual carriage highway.",
    features: [
  ...
  },
  {
    ...
    // UPDATED: Unique slug to prevent conflict
    slug: "royal-garden-kithyoko-phase-4",
    location: "Kithyoko",
    size: "50x100",
    price: "120,000",
    status: "Available",
    ...
    metaDescription:
      "Most affordable plots in Kithyoko Phase 4. Perfect for first-time land buyers with ready titles and community water.",
  ...
  },
  {
    ...
    metaDescription:
      "Amani Garden Malindi Phase 1 is officially sold out. Stay tuned for Phase 2 land listings along the Sala Gate bypass.",
  ...
  },
  {
    ...
    metaDescription:
      "Fadhili Garden Makutano gated community project is sold out. Check our other prime land developments in Mwea.",
  ...
  },
  {
    ...
    metaDescription:
      "Pre-book prime land in Kithyoko Phase 6. Coming soon with the same high standards as our previous successful phases.",
