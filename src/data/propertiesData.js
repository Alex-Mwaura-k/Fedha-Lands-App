...
export const properties = [
  {
    ...
    description:
      "Located just 9 minutes from the Thika-Garissa highway, Royal Garden Phase 5 offers a serene environment perfect for immediate settlement. The soil is red, suitable for farming, and the area is rapidly developing.",
    features: [
      "Ready Title Deeds",
      "Water on Site",
      "Electricity Nearby",
  ...
  },
  {
    ...
    description:
      "A massive 1-acre block ideal for holiday homes, speculation, or large scale farming. Located near the Weru Technical Institute, this project promises high returns on investment.",
  ...
  },
  {
    ...
    description:
      "Prime commercial and residential plots in the heart of Makutano. Extremely high value appreciation rate. Ideal for building rental flats or commercial centers.",
    features: [
      "Commercial Zone",
      "Water & Electricity",
      "Perimeter Fence",
  ...
  },
  {
    ...
    description:
      "Our most affordable project yet. Located 10 minutes from Kavaini shopping center. Perfect for first-time investors looking to secure land cheaply.",
  ...
  },
  {
    ...
    description:
      "Sold out project. Located along the Sala Gate bypass. Keep watching for Phase 2 opening soon.",
  ...
  },
  {
    ...
    description:
      "Fully sold out. This project set the standard for gated communities in the Makutano area.",
    features: ["Sold Out", "Gated Community"],
    mapSrc: "",
  },
  // Added a 7th item to test "View All" functionality
  {
    id: 7,
    ...
    img: "/img/properties/Royal Gardens 5.png",
    description:
      "The next phase of our popular Royal Garden series. Pre-booking available now.",
