...
const PropertyDetails = () => {
  ...
  // --- UPDATED: Image Helper using .env variables ---
  const getImageUrl = (path) => {
    ...
    // Use VITE_MEDIA_URL from .env with local fallback
  ...
  const schemaData = {
    ...
    brand: { "@type": "Brand", name: COMPANY_DATA.name },
    offers: {
      "@type": "Offer",
  ...
  return (
    <div className="property-details-page bg-light pb-5">
      <Helmet>
        <title>{property.title} | Fedha Land Ventures</title>
        <meta
          name="description"
          content={
            property.metaDescription ||
            `For Sale: ${property.title} in ${property.location}. Price: KES ${property.price}. Contact ${COMPANY_DATA.name} for a site visit.`
          }
        />
        <meta
          property="og:title"
          content={`${property.title} - KES ${property.price}`}
        />
        <meta
          property="og:description"
          content={`Check out this property in ${
            property.location
          }. ${property.description?.substring(0, 100)}...`}
        />
        <meta property="og:image" content={getImageUrl(property.img)} />
          ...
          <div className="col-lg-4 d-flex flex-column">
            <div className="bg-white p-4 rounded shadow-lg">
              ...
              <div className="d-grid gap-3">
                ...
                <a
                  href={`https://wa.me/${COMPANY_DATA.phoneLink}?text=Hi, I am interested in ${property.title}`}
                  target="_blank"
                  rel="noreferrer"
